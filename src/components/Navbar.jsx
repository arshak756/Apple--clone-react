function Navbar() {
    ...
    return (
        <>
           <nav className="fixed top-0 left-0 z-50 w-full bg-white bg-opacity-100 md:bg-opacity-75 text-black shadow-md py-2 px-4 flex items-center justify-between md:justify-center">
            ...
            <div className=" mt-16 w-full flex items-center justify-between md:justify-center space-x-6 md: gap-7 bg-white text-black py-2 px-4 ">
                <h2>Get up to 12 months of No Cost EMI plus up to ₹8000.00 instant cashback‡ on selected products with eligible cards.</h2>
            </div>
        </>
    )
